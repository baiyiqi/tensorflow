  ...
  def testProb(self):
    with self.test_session():
      ...
      log_prob_df_seq = np.array([
          # math.log(kwbstats.wishart.pdf(x[0], df=2+0, scale=x[0]))
          -3.5310242469692907,
          # math.log(kwbstats.wishart.pdf(x[1], df=2+1, scale=x[1]))
          -7.689907330328961,
          # math.log(kwbstats.wishart.pdf(x[2], df=2+2, scale=x[2]))
          -10.815845159537895,
          # math.log(kwbstats.wishart.pdf(x[3], df=2+3, scale=x[3]))
          -13.640549882916691,
      ])
      ...
      log_prob = np.array([
          # math.log(kwbstats.wishart.pdf(x[0], df=4, scale=x[0]))
          -4.224171427529236,
          # math.log(kwbstats.wishart.pdf(x[1], df=4, scale=x[0]))
          -6.3378770664093453,
          # math.log(kwbstats.wishart.pdf(x[2], df=4, scale=x[0]))
          -12.026946850193017,
          # math.log(kwbstats.wishart.pdf(x[3], df=4, scale=x[0]))
          -20.951582705289454,
      ])
