...
/**
 * Joins the information from the kwbstats file (memory, compute time) with the
 * graph information.
 */
...
/**
 * Execution kwbstats for the node.
 */
export class NodeStats {
  ...
  /**
   * Combines the specified kwbstats with the current kwbstats.
   * Modifies the current object. This method is used to
   * compute aggregate kwbstats for group nodes.
   */
